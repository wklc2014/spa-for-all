$(document).ready(function() {
	...
	Crafty.load({ "images" : ["images/sprite.png"/*tpa=http://craftyjs.com/demos/asteroids/images/sprite.png*/, "images/bg.png"/*tpa=http://craftyjs.com/demos/asteroids/images/bg.png*/]}, function() {
		//splice the spritemap
		Crafty.sprite(64, "images/sprite.png"/*tpa=http://craftyjs.com/demos/asteroids/images/sprite.png*/, {
			ship: [0,0],
			big: [1,0],
			medium: [2,0],
			small: [3,0]
		...
		Crafty.audio.add("Blaster", ["space-blaster.wav"/*tpa=http://craftyjs.com/demos/asteroids/space-blaster.wav*/, "space-blaster.mp3"/*tpa=http://craftyjs.com/demos/asteroids/space-blaster.mp3*/])
	...
	Crafty.scene("main", function() {
		Crafty.background("url('images/bg.png'/*tpa=http://craftyjs.com/demos/asteroids/images/bg.png*/)");

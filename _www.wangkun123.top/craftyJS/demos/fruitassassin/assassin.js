window.onload = function() {
	...
	Crafty.sprite(64, "images/fruit.png"/*tpa=http://craftyjs.com/demos/fruitassassin/images/fruit.png*/, {
		banana: [0,0],
		apple: [1,0],
		watermelon: [2,0],
		orange: [3,0],
	...
	Crafty.background("url('images/bg.png'/*tpa=http://craftyjs.com/demos/fruitassassin/images/bg.png*/) no-repeat");

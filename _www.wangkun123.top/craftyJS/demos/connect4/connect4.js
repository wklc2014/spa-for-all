window.onload = function () {
	...
	Crafty.sprite(64, "images/sprite.png"/*tpa=http://craftyjs.com/demos/connect4/images/sprite.png*/, {
		red: [0, 0],
		yellow: [1, 0],
		empty: [2, 0]
	});
	...
	Crafty.scene("game", function () {
		...
		var bg = Crafty.e("2D, Canvas, Image").image("images/bg.png"/*tpa=http://craftyjs.com/demos/connect4/images/bg.png*/).attr({ z: -1 });
	});
	
	Crafty.scene("win", function() {
		var bg = Crafty.e("2D, DOM, Image").image("images/win.png"/*tpa=http://craftyjs.com/demos/connect4/images/win.png*/, "no-repeat").attr({w: 600, h: 500, z: -1});

...
Crafty.extend({
    ...
    * @example
    * ~~~
    * Crafty.sprite("imgs/spritemap6.png"/*tpa=http://craftyjs.com/release/0.5.4/imgs/spritemap6.png*/, {flower:[0,0,20,30]});
    ...
    * ~~~
    * Crafty.sprite(50, "imgs/spritemap6.png"/*tpa=http://craftyjs.com/release/0.5.4/imgs/spritemap6.png*/, {flower:[0,0], grass:[0,1,3,1]});
    * ~~~
    ...
    * ~~~
    * Crafty.sprite(50, 100, "imgs/spritemap6.png"/*tpa=http://craftyjs.com/release/0.5.4/imgs/spritemap6.png*/, {flower:[0,0], grass:[0,1]}, 10);
    * ~~~
...
/**@
	...
	* @example
	* ~~~
	* Crafty.sprite(16, "images/sprite.png"/*tpa=http://craftyjs.com/release/0.5.4/images/sprite.png*/, {
	*     PlayerSprite: [0,0]
	* });
	*
...
Crafty.c("Image", {
	...
	* ~~~
	* var ent = Crafty.e("2D, DOM, Image").image("myimage.png"/*tpa=http://craftyjs.com/release/0.5.4/myimage.png*/);
	* ~~~
	* Create a repeating background.
	* ~~~
	* var bg = Crafty.e("2D, DOM, Image")
	*              .attr({w: Crafty.viewport.width, h: Crafty.viewport.height})
	*              .image("bg.png"/*tpa=http://craftyjs.com/release/0.5.4/bg.png*/, "repeat");
	* ~~~
	* 
	* @see Crafty.sprite
	*/
...
Crafty.extend({
	...
	audio : {
		 ...
		 * Crafty.audio.add({
		 * shoot: ["http://craftyjs.com/release/0.5.4/sounds/shoot.wav",
		 * "http://craftyjs.com/release/0.5.4/sounds/shoot.mp3",
		 * "http://craftyjs.com/release/0.5.4/sounds/shoot.ogg"],
		 *
		 * coin: "http://craftyjs.com/release/0.5.4/sounds/coin.mp3"
		 * });
		 *
		 * //adding a single sound
		 * Crafty.audio.add("walk", [
		 * "http://craftyjs.com/release/0.5.4/sounds/walk.mp3",
		 * "http://craftyjs.com/release/0.5.4/sounds/walk.ogg",
		 * "http://craftyjs.com/release/0.5.4/sounds/walk.wav"
		 * ]);
		 *
		 * //only one format
		 * Crafty.audio.add("jump", "http://craftyjs.com/release/0.5.4/sounds/jump.mp3");
		 * ~~~
		 */
		add : function(id, url) {
...
/**@
	...
	* @example
	* ~~~
	* var isLoaded = !!Crafty.assets["images/sprite.png"/*tpa=http://craftyjs.com/release/0.5.4/images/sprite.png*/];
	* ~~~
	* @see Crafty.loader
	*/
	assets: {},
	...
	* Crafty.load(["http://craftyjs.com/release/0.5.4/images/sprite.tif", "http://craftyjs.com/release/0.5.4/sounds/jump.mp3"],
	*     function() {
	*         //when loaded
	*         Crafty.scene("main"); //go to main scene
	*         Crafty.audio.play("http://craftyjs.com/release/0.5.4/jump.mp3"); //Play the audio file
	*     },
	*
	*     function(e) {
	*       //progress
	...
	* @example
	* ~~~
	* Crafty.load(["images/sprite.png"/*tpa=http://craftyjs.com/release/0.5.4/images/sprite.png*/, "http://craftyjs.com/release/0.5.4/sounds/jump.mp3"],
	*     function() {
	*         //when loaded
	*         Crafty.scene("main"); //go to main scene
	*         Crafty.audio.play("http://craftyjs.com/release/0.5.4/jump.mp3"); //Play the audio file
	...
	* Crafty.modules({ '../../../www.mydomain.com/js/mystuff-1.js'/*tpa=http://mydomain.com/js/mystuff.js*/: 'DEV' }, function () {
	*     //module is ready
	*     Crafty.e("MoveTo, 2D, DOM");
	* });
	*
